...
1. 本机资料先按 `00-AI/pipeline/local-material-intake.md` 判断范围和类型。
2. 外部资料先进入 `01-Inbox/web-clips/` 或用 `00-AI/scripts/kb.py intake-source` 创建资料分析卡。
3. 用 `00-AI/templates/TPL-source-analysis-card.md` 判断资料价值。
...
- `question_text`、`applicable_to` 不写入原始剪藏，只写入 `00-AI/templates/TPL-question-knowledge-experience-asset-card.md`。
